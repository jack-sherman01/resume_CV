...
\profile{
  ...
  \degree{Master Student in Robotics}
...
\begin{educations}
  \education%
    ...
    {Control Engineering   \quad \textbf{GPA}:4.45 \textbf{Rank}:1/25}%
    {master student}\\
...
\begin{competences}[6em]
  ...
  \comptence{Honors}{%
  \textbf{1.}Winner of The Excellent Graduate Student,\textbf{2.}
    Outstanding student leaders model
  }
