...
\fileinfo{%
  \faCopyright{} 2019--2023, Heng Zhang \hspace{0.5em}
...
\profile{
  \mobile{+39 3277123570}
  \email{Heng.Zhang@iit.it}
  \github{jack-sherman01} \\
  \degree{PhD Student}
  \university{{\href{https://hri.iit.it/}{Italian Institute of Technology (IIT)}}}
%  \birthday{1991 Sept.}
  \address{{\href{https://map.baidu.com/poi/\%E5\%90\%8C\%E6\%B5\%8E\%E5\%A4\%A7\%E5\%AD\%A6(\%E5\%98\%89\%E5\%AE\%9A\%E6\%A0\%A1\%E5\%8C\%BA)/@13494364.643751916,3648482.850872894,16.52z?uid=42e616dc8441c16b704b870e\&ugc_type=3\&ugc_ver=1\&device_ratio=2\&compat=1\&querytype=detailConInfo\&da_src=shareurl}{Genova, Italy}}}
...
%======================================================================
I am now a PhD student at \link{https://hri.iit.it/}{HRII} Lab at Italian Institute of Technology (IIT), supervised by Dr. \link{https://scholar.google.it/citations?hl=en&user=1hKOgRoAAAAJ&view_op=list_works&sortby=pubdate} {Arash Ajoudani}, highly-motivated in robotics with good foundations of math and programming, proficient in data modeling and analysis, and enthusiastic about computer and the corresponding interdisciplinary subject.
...
%======================================================================
\begin{itemize}
\item \textbf{Variable Stiffness-based Safe Reinforcement Learning for Contact-rich Robotic Maze Exploration} \quad [under review]\\
...
\begin{competences}[6em]
  \comptence{Reviewer}{TCDS, CAC2021,2022}
